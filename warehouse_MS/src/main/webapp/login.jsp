        ...
        <div class="signin-signup">
            <form method="post" action="<%=request.getContextPath()%>/loginServlet" class="sign-in-form">
                ...
                <div class="input-field">
                    ...
                    <img src="./img/true.svg" alt="" class="icon-tips"/>
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    <label class="input-clerk">
                        <input type="radio" name="authority" class="radio-status-clerk" value="1" checked />
                        <span class="clerk">职员</span>
                    </label>
                    <img src="./img/矩形.svg" alt="" class="rectangle" />
                    <label class="input-admin">
                        <input type="radio" name="authority" value="0" class="radio-status-admin" />
            ...
            <form action="<%=request.getContextPath()%>/registerServlet" method="post" class="sign-up-form">
                ...
                <div class="input-field">
                    ...
                    <img src="./img/矩形.svg" alt="" class="rectangle" />
                    <label class="input-admin">
                        <input type="radio" name="authority" class="radio-status-admin" value="0" />
                        <span class="admin">管理员</span>
                    </label>
                </div>
